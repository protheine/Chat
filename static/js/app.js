...
$(document).ready(function() {
    ...
    $.post("/room/testroom", function (data) {
        ...
        ws.onopen = function () {
            ...
            $('#mCSB_3_container').attr({style: 'position: relative; top: -' + dimension + 'px; left: 0px;'}); // Can't handle Internet explorer like that because style output ins not the same order
